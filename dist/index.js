...
function bubbleSortByBrightness(circles, i, j, delay_ms) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (j >= circles.length - i - 1) {
            ...
            yield new Promise(resolve => setTimeout(resolve, delay_ms)); // Adjust delay as needed
...
function selectionSortByBrightness(circles, i, delay_ms) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield selectionSortByBrightness(circles, i + 1, delay_ms);
    });
}
function sleep(delay_ms) {
    return new Promise(resolve => setTimeout(resolve, delay_ms));
}
function appendCircleWithDelay(circle, delay) {
    return __awaiter(this, void 0, void 0, function* () {
        yield sleep(delay); // Wait for the specified delay
        if (circleContainer) {
...
function shuffleCircles(totalCircles, circles) {
    return __awaiter(this, void 0, void 0, function* () {
        const hue = 200;
        for (let i = 0; i < totalCircles; i++) {
            const brightness = Math.floor(Math.random() * (80) + 10);
...
function fillScreenWithCircles(circles) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < totalCircles; i++) {
            ...
            yield appendCircleWithDelay(circle, 10);
        }
    });
}
fillScreenWithCircles(circles);
if (shuffleButton) {
    shuffleButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
        if (!isDoneSorting) {
            ...
            yield shuffleCircles(totalCircles, circles);
            sorted = false;
        }
    }));
}
if (selectionSortButton) {
    selectionSortButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
        if (sorted) {
            alert("already sorted! Try shuffling.");
        }
        else {
            isDoneSorting = false;
            yield selectionSortByBrightness(circles, 0, 10);
            sorted = true;
            numberOfOperations = 0;
        }
    }));
...
if (bubbleSortButton) {
    bubbleSortButton.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
        if (sorted) {
            alert("already sorted! Try shuffling.");
        }
        else {
            ...
            yield bubbleSortByBrightness(circles, 0, 0, 1);
            console.log(isDoneSorting);
            sorted = true;
            numberOfOperations = 0;
        }
